...
// @version      2.0
// @description  제타 AI 채팅방의 글씨체 변경 및 창 이동/위치 기억/Ctrl+Enter 지원
// @author       You
...
(function () {
    ...
    // 1. 지원 폰트 목록 및 기본 설정
    // ==========================================
    const STORAGE_KEY = 'zeta_custom_font_settings_v5';
    ...
    const FONTS = [
        ...
        },
        {
            id: 'kopub-batang',
            name: 'KoPub 바탕',
            family: "'KoPubWorldBatang', 'KoPub World Batang', serif"
        }
    ];
    ...
    function init() {
        setTimeout(() => {
            ...
            registerShortcuts();
            observeZeta();
            console.log('[Zeta Font Selector] 나눔명조 제거 완료');
        }, 1000);
    }
